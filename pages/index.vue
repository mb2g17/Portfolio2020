    ...
    <v-container fluid id="aboutme" class="mb-5">
      <v-row>
        ...
        <v-col id="aboutme-body" cols="12" md="8">
          ...
          <p>I am a software developer with a passion for automation, <a class="white--text" href="https://www.fsf.org/">Free</a> and <a class="white--text" href="https://opensource.org/">open source</a> software, and cool programs that do cool things.</p>
